...
const SECTIONS = [
  ...
  { id: 'accounts', title: '2. Account Registration', icon: Users },
  { id: 'subscriptions', title: '3. Subscriptions & Billing', icon: CreditCard },
  { id: 'conduct', title: '4. Prohibitions & Cyber Law', icon: ShieldAlert },
  { id: 'roles', title: '5. Role-Based Permissions', icon: Shield },
  { id: 'ip-rights', title: '6. Intellectual Property', icon: Globe },
  { id: 'liability', title: '7. Limitation of Liability', icon: AlertTriangle },
  { id: 'termination', title: '8. Account Termination', icon: Trash2 },
  { id: 'governing-law', title: '9. Governing Law', icon: Scale },
];

export const Terms = ({ children }: { children: React.ReactNode }) => {
        ...
        <div className="relative mb-14 text-center lg:text-left py-2">
          <div className="space-y-4 max-w-3xl">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/8 dark:bg-primary/5 border border-primary/20 text-[10px] font-bold text-primary uppercase tracking-wider">
              <Scale className="h-3.5 w-3.5" /> Last Updated: June 7, 2026
            </div>
            <h1 className="font-serif-display text-4xl sm:text-5xl md:text-6xl font-normal tracking-tight text-foreground leading-tight">
              Terms of <span className="brand-gradient-text font-semibold">Service</span>
            </h1>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed max-w-2xl">
              Please read these terms carefully. By accessing or using Syncline, you agree to comply with our workspace code of conduct, role permissions, and safety regulations.
            </p>
          </div>
        </div>
